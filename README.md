...
The app is Developer-ID signed and **notarized by Apple**, so it opens without
security warnings.

**Requirements:** Apple Silicon Mac (M1 or newer) · macOS 11 (Big Sur) or later.

---

## What it does

- **Import** time-lapse images, multi-well plates, microscopy stacks and videos
...
**[buy me a coffee ☕](https://github.com/sponsors/oktarguloglu?frequency=one-time&sponsor=oktarguloglu)**.
